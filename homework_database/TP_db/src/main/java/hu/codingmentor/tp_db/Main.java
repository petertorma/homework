...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        factory = Persistence.createEntityManagerFactory("TPdb");
        ...
        //  TypedQuery<Author> authorNameQuery = em.createNamedQuery("firtnameQuery", Author.class);
        //  Author testAuthorName = authorNameQuery.getSingleResult();
        ...
        // LOGGER.info(testAuthorName.toString());
